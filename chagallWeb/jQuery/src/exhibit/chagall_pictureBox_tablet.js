(function($){
    var tWrap=$('.t_wrap');
    var pEwrap=tWrap.find('.t_PE_wrap');
    var picWrap=pEwrap.find('.t_pic_wrap');
    var pUl=picWrap.children('.tab_frame');
    ...
    var next=pEwrap.find('.t_next');
    var prev=pEwrap.find('.t_prev');
...
var explainWrap=$('.t_explainwrap');
var explain='<div class="divWrap"><dl><dt class="name"></dt><dd class="year"></dd><dd class="size"></dd><dd class="meterial"></dd><dd class="age"></dd><dd class="location"></dd><dd class="content"></dd></dl></div>'
...
for(i=0; i<explanation.length; i+=1){
    ...
    name       = divWrapEq.find('.name');
    artist     = divWrapEq.find('.artist');
    year       = divWrapEq.find('.year');
    size       = divWrapEq.find('.size');
    ingredient = divWrapEq.find('.ingredient');
    age        = divWrapEq.find('.age');
    location   = divWrapEq.find('.location');
    content    = divWrapEq.find('.content');
...
reDiv= explainWrap.find('.divWrap');
